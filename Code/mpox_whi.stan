...
parameters {
  real<lower=-10, upper=3> log_lambda1;
  real<lower=-10, upper=3> log_lambda_I;

  real<lower=-7, upper=2> log_r;
  real<lower=-7, upper=2> log_d;
  real<lower=0.25, upper=35> m;
  real<lower=-6, upper=3> log_kappa;
  real<lower=-7, upper=2> log_sigma_z;
}
